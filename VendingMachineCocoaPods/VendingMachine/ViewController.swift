...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Apply Gradient to backgroundView
    ...
    func applyBackgroundGradient() {
        // Create a color gradient from gray to darker gray
        let lightGray = UIColor.grayColor()
        let darkGray  = UIColor.hex("#1E2428")
        let gradientLayer = [lightGray,darkGray].gradient()
        
        // Set the bounds of the gradient layer to dimensions of the backgroundview
        gradientLayer.frame = backgroundView.bounds;
        
        // Set the transition points for the gradient
        gradientLayer.locations = [0.0,0.5]
        
        // Insert the gradient layer into the view on the bottom layer (index 0)
